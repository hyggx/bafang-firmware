...
void MENU_AcceptSetting(void)
{
    ...
    switch (UI_MENU_GetCurrentMenuId())
    {
        ...
        case MENU_TXP:
            ...
            gRequestSaveChannel = 2;  // Mode 2 needed to persist power for MR channels
            return;
...
//          gRequestSaveChannel = 1;
        ...
        case MENU_LANG:
            gEeprom.LANGUAGE = (LangId_t)gSubMenuSelection;
            g_lang = gEeprom.LANGUAGE;
            SETTINGS_SaveLanguage(gEeprom.LANGUAGE);
            return;  // SaveLanguage already flushes; skip generic EEPROM save
...
void MENU_ShowCurrentSetting(void)
{
    switch (UI_MENU_GetCurrentMenuId())
    {
        ...
        case MENU_LANG:
            gSubMenuSelection = (int32_t)gEeprom.LANGUAGE;
            break;
...
static void MENU_Key_0_to_9(KEY_Code_t Key, bool bKeyPressed, bool bKeyHeld)
{
    ...
    {   // enter 3-digit channel number
        ...
        Value = ((gInputBox[0] * 10 + gInputBox[1]) * 10 + gInputBox[2]) - 1;
