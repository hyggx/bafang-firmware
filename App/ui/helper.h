...
/* UTF-8 aware big-font print: ASCII uses gFontBig (7px), CJK uses 12×12 glyph
 * cache.  Renders at column x, starting at framebuffer row line (uses line+1
 * too, same as UI_PrintString).  No clipping beyond x>=128.                  */
