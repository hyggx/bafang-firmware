...
#include "l10n/strings.h"   // LangId_t
...
enum {
    OUTPUT_POWER_LOW = 0,   // ~0.5W
    OUTPUT_POWER_MED,       // ~1W
    OUTPUT_POWER_HIGH,      // ~2W
    OUTPUT_POWER_TURBO      // ~5W
};
...
//#endif                                // Fix me !!! What the hell is this?
    ...
    uint8_t               S9_LEVEL;
#endif
    /* LINGBO_EXT_BEGIN — fields appended by Bafang firmware */
    LangId_t              LANGUAGE;       /* v2: UI language (LANG_EN / LANG_ZH) */
    /* LINGBO_EXT_END */
} EEPROM_Config_t;
